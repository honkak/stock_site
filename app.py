...
# ):
    ...
    # <script>
    # // 특정 텍스트가 포함된 요소를 숨기는 JavaScript
    # const elements = Array.from(document.querySelectorAll('div'));
    # elements.forEach(el => {
    #     if (el.innerText.includes('Psst! 👀 You found a secret section generated by streamlit-analytics')) {
...
with streamlit_analytics.track(unsafe_password="qqqq"):
    ...
    # Analytics Dashboard 글자 크기 조정 및 특정 텍스트 숨김
    st.markdown("""
    <style>
    /* Analytics Dashboard 크기 조정 */
    div[data-testid="stMarkdownContainer"] h1 {
