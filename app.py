...
# 종목 코드와 이름 표시
st.write(f"code1: {code1} ({stocks_info.get(code1.strip(), '이름을 찾을 수 없습니다.')})")
st.write(f"code2: {code2} ({stocks_info.get(code2.strip(), '이름을 찾을 수 없습니다.')})")
st.write(f"code3: {code3} ({stocks_info.get(code3.strip(), '이름을 찾을 수 없습니다.')})")
